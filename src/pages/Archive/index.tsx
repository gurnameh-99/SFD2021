    ...
    return <>
        <Container>
            ...
            <CustomRow justify="space-between">
                ...
                />
                <CustomCard 
                    imagePath="/img/archive/Sonia singla.jpg"
                    SocialLink="https://www.linkedin.com/in/soniasinglas/"
                    openVid={openVid}
                    setVideo={setVideo}
                    setOpen={setOpen}
                    videoId="2oAoFXDRbuA"
                    title="Sonia singla"
                    description="Sonia was a Community Bridge Mentee at Cloud Native Computing Foundation in 2020 and Outreachy 2019 intern at Mozilla. Currently pursuing her B.E in Information Technology, she is a Mozilla represetative and an avid Open- Source Contributor." 
                />
            </CustomRow>
        </Container>
    </>;
